...
typedef struct _PMU_SMB_ATE_t {
  ...
  uint8_t  AcLoopLaneMask_01_00;  // Byte Offset: 0x2e / CSR Address: 0x54017
  uint8_t  AcLoopLaneMask_03_02;  // Byte Offset: 0x2f / CSR Address: 0x54017
  uint8_t  AcLoopLaneMask_05_04;  // Byte Offset: 0x30 / CSR Address: 0x54018
  uint8_t  AcLoopLaneMask_07_06;  // Byte Offset: 0x31 / CSR Address: 0x54018
  uint8_t  AcLoopLaneMask_09_08;  // Byte Offset: 0x32 / CSR Address: 0x54019
  uint8_t  AcLoopLaneMask_11_10;  // Byte Offset: 0x33 / CSR Address: 0x54019

  uint8_t  AcLoop_rsvd_0;         // Byte Offset: 0x34 / CSR Address: 0x5401a
  uint8_t  AcLoop_rsvd_1;         // Byte Offset: 0x35 / CSR Address: 0x5401a
  ...
  //Note: The MinPadLpbkPwr (below) also affects the operation of the AC loopback test.
  ...
  uint16_t MinPadLpbkPwr;   // Byte Offset: 0x3e / CSR Address: 0x5401f
                            //  Used by Data and AC Pad Loopback to serialize testing of the dbytes/acx4 instances.
                            //  That is, it tests one dbyte/acx4 at a time and configures unused dbytes/acx4 for lower power
                            //  This only has an effect when testing pad loopback (not core).
