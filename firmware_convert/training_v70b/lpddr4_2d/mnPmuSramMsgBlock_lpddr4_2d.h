typedef struct _PMU_SMB_LPDDR4_2D_t {
   uint8_t  Reserved00;       // Byte offset 0x00, CSR Addr 0x54000, Direction=N/A
   ...
   uint8_t  X8Mode;           // Byte offset 0x1c, CSR Addr 0x5400e, Direction=In
                              // Phy is populated with x8 mode devices
                              // 
                              // A value of 0b00000000 indicates that X8 devices are not present in any rank.
                              // A value of 0b00000001 indicates that X8 devices are present in all ranks.
                              // Mixed configurations (X8 on some ranks but not others) is not supported.
   ...
   uint8_t  Reserved22;       // Byte offset 0x22, CSR Addr 0x54011, Direction=N/A
                              // This field is reserved and must be programmed to 0x00.
   uint8_t  Reserved23;       // Byte offset 0x23, CSR Addr 0x54011, Direction=N/A
                              // This field is reserved and must be programmed to 0x00.
